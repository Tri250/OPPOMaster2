        ...
        <div className="bg-gradient-to-br from-[#FF6B35] to-[#FF8C42] rounded-2xl p-5 text-white">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-master-text-secondary text-sm">自动同步已开启</p>
              <div className="flex items-center gap-2 mt-3">
                <span className="text-master-text-secondary text-xs">最后同步：2分钟前</span>
              </div>
            </div>
          </div>
          <button
            onClick={handleSync}
            disabled={isSyncing}
            className="w-full mt-4 py-3 bg-master-glass-strong hover:bg-master-glass-strong rounded-xl font-medium flex items-center justify-center gap-2 transition-all duration-normal disabled:opacity-50 active:scale-95"
          >
              ...
              return (
                ...
                >
                  ...
                  {provider.status === 'connected' ? (
                    ...
                    <button className="text-sm text-[#FF6B35] font-medium active:scale-95">连接</button>
                  )}
                </div>
              );
            })}
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-master-text-tertiary">最后同步：{item.lastSync}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className={`text-xs px-2 py-1 rounded-full ${
                      item.enabled ? 'bg-[#4CAF50]/20 text-[#4CAF50]' : 'bg-master-glass-strong text-master-text-tertiary'
                    }`}>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-3 bg-master-glass rounded-xl">
              ...
              <div>
                ...
                <p className="text-xs text-master-text-tertiary mt-0.5">您的数据完全加密，安全可靠</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-master-glass rounded-xl">
              ...
              <div>
                ...
                <p className="text-xs text-master-text-tertiary mt-0.5">仅在 Wi-Fi 下自动同步，节省流量</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-master-glass rounded-xl">
              <div className="p-2 bg-[#FF6B35]/20 rounded-lg">
              ...
              <div>
                ...
                <p className="text-xs text-master-text-tertiary mt-0.5">保留 30 天历史版本，随时回退</p>
              </div>
            </div>
          </div>
        </div>
