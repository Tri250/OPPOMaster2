...
class LUTPreviewRenderer(context: Context) {
                ...
                for (gy in 0 until 8) {
                    for (gx in 0 until 8) {
                        ...
                        if (pixelIndex < pixels.size) {
                            val rgb = lutData.sampleTrilinear(r / 511f, g / 511f, b / 511f)
    ...
    fun drawFrame() {
        ...
        GLES10.glBindTexture(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, cameraTextureId)
    ...
    private fun createOESTexture(): Int {
        ...
        val id = textures[0]
        GLES10.glBindTexture(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, id)
        GLES10.glTexParameterf(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, GLES10.GL_TEXTURE_MIN_FILTER, GLES10.GL_LINEAR.toFloat())
        GLES10.glTexParameterf(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, GLES10.GL_TEXTURE_MAG_FILTER, GLES10.GL_LINEAR.toFloat())
        GLES10.glTexParameterf(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, GLES10.GL_TEXTURE_WRAP_S, GLES10.GL_CLAMP_TO_EDGE.toFloat())
        GLES10.glTexParameterf(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, GLES10.GL_TEXTURE_WRAP_T, GLES10.GL_CLAMP_TO_EDGE.toFloat())
        return id
    }
}
